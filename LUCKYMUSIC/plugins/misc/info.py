...
bg_path = "LUCKYMUSIC/assets/lucky/LuckyNinfo.png"
font_path = "LUCKYMUSIC/assets/lucky/rajainf.ttf"
    ...
    if not message.reply_to_message and len(message.command) == 2:
        try:
            ...
            if user.photo:
                ...
                # User doesn't have a profile photo, use luckyphoto directly
                welcome_photo = random.choice(luckyphoto)
