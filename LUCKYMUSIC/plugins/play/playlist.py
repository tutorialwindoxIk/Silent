...
from LUCKYMUSIC.utils import close_markup
from config import BANNED_USERS, SERVER_PLAYLIST_LIMIT
from LUCKYMUSIC import Carbon, app
from LUCKYMUSIC.utils.decorators.language import language, languageCB
from LUCKYMUSIC.utils.inline.playlist import (botplaylist_markup,
                                              get_playlist_markup,
                                              warning_markup)
from LUCKYMUSIC.utils.pastebin import LUCKYBIN
import time
import yt_dlp
...
from LUCKYMUSIC.core.mongo import mongodb
...
async def add_playlist(client, message: Message, _):
    ...
    if "https://youtu.be" in query:
        ...
        from LUCKYMUSIC import YouTube
...
@app.on_callback_query(filters.regex("raja_playlist") & ~BANNED_USERS)
@languageCB
async def add_playlist(client, CallbackQuery, _):
    callback_data = CallbackQuery.data.strip()
    videoid = callback_data.split(None, 1)[1]
