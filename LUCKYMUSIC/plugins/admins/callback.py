...
from LUCKYMUSIC import YouTube, app
from LUCKYMUSIC.core.call import RAJA
from LUCKYMUSIC.misc import SUDOERS, db
...
from LUCKYMUSIC.utils.formatters import seconds_to_min
from LUCKYMUSIC.utils.inline import close_markup, stream_markup, stream_markup_timer
from LUCKYMUSIC.utils.inline.play import panel_markup_1, panel_markup_2, panel_markup_3
from LUCKYMUSIC.utils.stream.autoclear import auto_clean
from LUCKYMUSIC.utils.thumbnails import get_thumb
...
async def del_back_playlist(client, CallbackQuery, _):
    ...
    if command == "Pause":
        ...
        await RAJA.mute_stream(chat_id)
        await CallbackQuery.message.reply_text(
        ...
        await RAJA.unmute_stream(chat_id)
        await CallbackQuery.message.reply_text(
